...
1-3-2. shebangらしき行って？
 ...
 (という説明ではわかりませんよね..。要するに、1行目1文字目が #! で始まっている場合、# で始まっている2行目以降も、コメント行と見なすということです。)
...
1-4-1. 「名前を付けて」保存はしないようにはできる？
 　もちろんできます。秀丸の「ファイル名変更」のような動作になります。

1-4-2. それ以外の機能は？
 　もしも保存先のフォルダが存在しない場合は、マクロが作ります。もちろん、改名後のファイル名と同じファイル名のファイルがあるか確認します。
